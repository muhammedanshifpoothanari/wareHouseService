...
const getAllByWareHouseName = (wareHouseName) => __awaiter(void 0, void 0, void 0, function* () {
    if (!wareHouseName)
        throw new Error('WareHouse name was not properly passed to the repository!');
    const wareHouseModel = modelToGetWareHouseByName();
    try {
        const wareHouseArray = yield wareHouseModel.find({ wareHouseName: wareHouseName }).exec();
