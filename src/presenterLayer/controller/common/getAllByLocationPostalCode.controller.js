...
const getAllByLocationPostalUseCaseCntrl = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(getAllByLocationPostalUseCaseCntrl, 'hdhdhhdhd');
        const locationPostalCode = req.body.locationPostalCode;
        const wareHouse = yield wrappedFunction(locationPostalCode);
